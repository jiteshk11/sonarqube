...
public class ServerUserSessionTest {
  ...
  AuthorizationDao authorizationDao = dbClient.authorizationDao();
  ...
  public void has_global_permission() {
    ...
    UserSession session = newServerUserSession(userDto);
  ...
  public void fail_if_user_dto_is_null() throws Exception {
    ...
    newServerUserSession(null);
  }

  private ServerUserSession newServerUserSession(UserDto userDto) {
