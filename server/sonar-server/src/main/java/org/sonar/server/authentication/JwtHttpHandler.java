...
public class JwtHttpHandler {
  ...
  void generateToken(UserDto user, HttpServletResponse response) {
    ...
    threadLocalUserSession.set(new ServerUserSession(dbClient, user));
  }
  ...
  boolean validateToken(HttpServletRequest request, HttpServletResponse response) {
    ...
    Optional<UserDto> user = validateToken(token.get(), request, response);
  ...
  private Optional<UserDto> validateToken(String tokenEncoded, HttpServletRequest request, HttpServletResponse response) {
    ...
    threadLocalUserSession.set(new ServerUserSession(dbClient, user.get()));
    return user;
  }
